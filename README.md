...
![Data Flow](https://github.com/KyberNetwork/kyberswap-android/blob/master/images/clean_architecture_flow.svg)
...
* We use automatic code review bot (danger) to adopt Ktlint, Findbugs, detekt, AndroidLint static analysis tool
