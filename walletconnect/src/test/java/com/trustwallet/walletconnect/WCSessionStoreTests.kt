...
class WCSessionStoreTests {
    ...
    fun test_store() {
        val topic = "topic_1"
        val session =
            WCSession.from("wc:$topic@1?bridge=https%3A%2F%2Fbridge.walletconnect.org&key=some_key")!!
        val item = WCSessionStoreItem(
            session,
            "peerId",
            WCPeerMeta(name = "Some DApp", url = "https://dapp.com")
        )
