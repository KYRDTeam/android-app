...
class PinLockAdapter :
    ...
    inner class NumberViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        internal var mNumberButton: Button = itemView.findViewById<View>(R.id.button) as Button
    ...
    inner class DeleteViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        internal var mDeleteButton: LinearLayout =
            itemView.findViewById<View>(R.id.button) as LinearLayout
        internal var mButtonImage: ImageView =
            itemView.findViewById<View>(R.id.buttonImage) as ImageView
